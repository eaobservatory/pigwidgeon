...
function addInput(divName){
	...
	if (divName == "paperTable"){
	    cell1.innerHTML = "<input type='text' name=ptname" + (papercounter + 1) + ">";
	    ...
	    cell4.innerHTML = "<select name='infotype'><option value='0'>Radio Boxes</option><option value='1'>Check Boxes</option><option value='2'>Text entry (1 per line)</option><option value='3'>Text entry (free form)</option></select>";
	    infocounter++
